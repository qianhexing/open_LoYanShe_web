          ...
          <template #default="{ isActive }">
            <div v-if="isActive" class="p-4 max-md:p-2">
              ...
              <div class="flex max-md:block gap-4 mb-4">
                <!-- 主图 -->
                <div class="flex-1">
                  <div v-if="detail.sence_id" class="aspect-[3/4] rounded-lg overflow-hidden mb-4">
                    <iframe :src="`https://lolitalibrary.com/scene/detail/${detail.sence_id}`"
                      class="w-full h-full border-0" frameborder="0"></iframe>
                  </div>
                  <div v-else-if="detail.include && detail.include.length > 0" class="mb-4">
                ...
                <div class="flex-1 space-y-3">
                  ...
                  <div v-if="detail.library" class="border-t pt-3 mt-3">
                    ...
                    <div v-if="detail.library.pattern_elements" class="text-sm mb-2 flex items-center gap-2 flex-wrap">
                      柄图：
